<template>
  <q-page class="flex flex-center">
    <Table title="管理帳號" :API="API" :pagination-setting="pagination" :columns="columns" />
  </q-page>
</template>
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'account', align: 'center', label: '帳號', field: 'Account', sortable: true },
        {
          name: 'name',
          align: 'center',
          label: '姓名',
        ...
        { name: 'createdAt', align: 'center', label: '建立日期', field: 'CreatedAt', sortable: true }
      ],
      data: [],
      original: [
